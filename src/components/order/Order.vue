  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column label="是否发货" prop="is_end">
    ...
    <!--修改对话框-->
    <el-dialog title="修改地址" :visible.sync="addresVissible" width="50%" @close='addressDialogClosed'>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addresVissible = false">取 消</el-button>
        <el-button type="primary" @click="addresVissible = false">确 定</el-button>
      </span>
    </el-dialog>
